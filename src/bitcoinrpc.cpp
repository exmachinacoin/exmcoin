...
{
    return GetBoolArg("-testnet", false) ? 23261 : 24261;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop EXMcoin server (and possibly override the detachdb config value).");
