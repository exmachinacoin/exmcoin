...
static const int LAST_POW_BLOCK = 42000000; //about 10,000 Years of PoW blocks
...
static const uint256 hashGenesisBlock("0x00000b5221d551bf1bed4df2c42e0defa61464b901e16f40016dd49fae9d558b");
static const uint256 hashGenesisBlockTestNet("0x00000b5221d551bf1bed4df2c42e0defa61464b901e16f40016dd49fae9d558b");
...
public:
    ...
    {
        // EXMcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // EXMcoin: get transaction coin age
...
public:
    ...
    // EXMcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // EXMcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // EXMcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // EXMcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // EXMcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // EXMcoin: block index flags
    enum  
    {
